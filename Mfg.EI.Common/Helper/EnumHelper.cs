    ...
    public abstract class EnumHelper
    {
        ...
        public static string GetEnumDesc(object obj)
        {
            ...
            try
            {
                ...
                System.ComponentModel.DescriptionAttribute description = null;

                if (isTop)
                {
                    description = (System.ComponentModel.DescriptionAttribute)Attribute.GetCustomAttribute(enumType, typeof(DescriptionAttribute));
                }
                else
                {
                    FieldInfo field = enumType.GetField(Enum.GetName(enumType, obj));
                    description = (System.ComponentModel.DescriptionAttribute)Attribute.GetCustomAttribute(
