...
namespace Mfg.EI.DBHelper
{
    ...
    public abstract class MySQLHelper
    {
        ...
        public static string connectionString = ConfigInfo.ConnectionString;
        public MySQLHelper()
        {
        }
        ...
        /// <param name="SQLString">查询语句</param>
        /// <returns>DataSet</returns>
        public static DataSet Query(string SQLString, List<MySqlParameter> cmdParms)
        {
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                MySqlCommand cmd = new MySqlCommand();
        ...
        /// <returns></returns>
        public static List<T> ExecuteStatement<T>(String statement, Func<MySqlDataReader, T> readFunc, List<MySqlParameter> parameters, CommandType commandtext = CommandType.Text)
        {
        ...
        public static T ExecuteStatementList<T>(String statement, Func<MySqlDataReader, T> readFunc, List<MySqlParameter> parameters, CommandType commandtext = CommandType.Text)
        {
            T results = default(T);
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
