...
/***/ function(module, exports, __webpack_require__) {
	...
	function mockSelect(dom, data, callbackId, callback, id){
	    this.dom = $("." + dom);
	    this.data = data;
	...
	module.exports = function(dom, data, callbackId, callback, id){
	    /**
	     * * 模拟下拉框组件
	     * 拿到id
	     * @param dom       下拉框父级class
	     * @param data      下拉数据（处理过的）
	     * @param callbackId      通过回调传给个人页面需要的id
	     * @param callback        个人页面的回调处理
	     * @param id              存放下拉选项的id
	     */
	    return new mockSelect(dom, data, callbackId, callback, id);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	/**/) {
	'use strict';var $utils=this,$helpers=$utils.$helpers,$each=$utils.$each,data=$data.data,$value=$data.$value,$index=$data.$index,$escape=$utils.$escape,$out='';$out+='<ul class="mock-ul display-none"> ';
