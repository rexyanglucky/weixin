	    ...
	    requestComment: function(){
	        ...
	        $.ajax({
	            ...
	            success: function(dt){
	                ...
	                tThis.initBtns(data.N.HomeworkStatus);
	            }
	        });
	    },
