...
/***/ function(module, exports, __webpack_require__) {
	...
	/**/) {
	'use strict';var $utils=this,$helpers=$utils.$helpers,$string=$utils.$string,QuestionBody=$data.QuestionBody,$out='';$out+='<div class="bg-white box-padding-left box-padding-right box-padding-top border-bottom box-padding-bottom pretext " style="overflow:hidden;zoom:1;"> ';
...
/***/ function(module, exports, __webpack_require__) {
	...
	$out+=$string(RightAnswer||"  ");
	$out+='</div> </div> <span class="color-green pretext">试题分析：</span> <div class="answer-ques"> <div id="explain-que pretext" style="overflow:hidden;zoom:1;color:black">';
