	            ...
	            if(data.Result){
	                ...
	                $.each(data.N.PlanPointsList,function(index,item){
	                    ...
	                    if(item.CurrentLever == 2){
	                        ...
	                        $('.testway').append('<div id='+item.PlanPointsID+'><p class="testway-title">知识点'+index+':'+item.PointName+'</p><div class="jingpin"><p>精品例题</p></div><div class="suitang"><p>随堂练习</p></div></div>');
	                    }
	                });
	            }
