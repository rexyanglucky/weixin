...
/***/ function(module, exports, __webpack_require__) {
	...
	//获取题型
	art.helper('getItemStyle',function (subject,style) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	/**/) {
	'use strict';var $utils=this,$helpers=$utils.$helpers,Subjectid=$data.Subjectid,QuestionType=$data.QuestionType,getItemStyle=$data.getItemStyle,include=function(filename,data){data=data||$data;var text=$utils.$include(filename,data,$filename);$out+=text;return $out;},$out='';$out+='{if } ';
	if((Subjectid,QuestionType|getItemStyle)==1 ){
	$out+=' ';
