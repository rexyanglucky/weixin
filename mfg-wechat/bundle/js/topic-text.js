...
/***/ function(module, exports, __webpack_require__) {
	...
	$out+='</span>， 回答： <span class="color-green" >正确 || "#<i style=\'font-style:normal;color:red\'>未作答</i>" </span>。 ';
	}else if(UserResult==0||UserResult==2){
	$out+=' <span class="color-red">';
	$out+=$string(UserAnswer || "#<i style='font-style:normal;color:red'>未作答</i>");
