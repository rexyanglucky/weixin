...
/***/ function(module, exports, __webpack_require__) {
	...
	var template=__webpack_require__(4);__webpack_require__(55);__webpack_require__(56);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/**/) {
	'use strict';var $utils=this,$helpers=$utils.$helpers,$escape=$utils.$escape,Score=$data.Score,$string=$utils.$string,UserAnswer=$data.UserAnswer,RightAnswer=$data.RightAnswer,QuestionAnalsis=$data.QuestionAnalsis,NoteContent=$data.NoteContent,$out='';$out+='<div> 得分： <div class="color-green" id="outcome">';
	$out+=$escape(Score);
	...
	$out+=$string(RightAnswer);
	$out+='</div> </div> <span class="color-green">试题分析：';
	$out+=$string(QuestionAnalsis);
	$out+='</span> <div class="answer-ques"> <div id="explain-que" style="overflow:hidden;zoom:1;">';
	$out+=$string(QuestionAnalsis);
	$out+='</div> <span class="color-green" >笔记：</span> <div class="color-siliver" id="text-book"> ';
	if(NoteContent==null){
	$out+=' <p class="color-siliver">(无)</p> ';
