...
/***/ function(module, exports, __webpack_require__) {
	...
	$out+=' </div> <span class="color-green">试题分析：</span> <div class="answer-ques" > <pre id="explain-que pretext">';
	$out+=$string(QuestionAnalsis);
	$out+='</pre> <span class="color-green pretext" >笔记：</span> <pre class="color-siliver pretext" id="text-book"> ';
	if(NoteContent==null){
...
/***/ function(module, exports, __webpack_require__) {
	...
	$out+=$string(RightAnswer||"  ");
	$out+='</pre> </div> <span class="color-green ">试题分析：</span> <div class="answer-ques"> <pre id="explain-que " class="pretext" style="overflow:hidden;zoom:1;color:black">';
	$out+=$string(QuestionAnalsis||"<br>");
	$out+='</pre> <span class="color-green " >笔记：</span> <pre class="color-siliver pretext" id="text-book"> ';
	if(NoteContent==null){
