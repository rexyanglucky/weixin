	...
	module.exports={
	    ...
	    go_menu:function(conId){
	        ...
	        function menuBody(){
	            ...
	            var h=document.clientHeight+"px";
	            if(menuShow){
