...
/***/ function(module, exports, __webpack_require__) {
	...
	$out+='分</span>，满分：';
	$out+=$escape(AllScore);
	$out+='分</div> <span class="color-green ">您的答案：</span><pre class="color-black pretext" >';
	$out+=$string($helpers. unEscape(UserAnswer ));
	$out+='</pre> <span class="color-green ">正确答案：</span> <pre class="color-black pretext" >';
	$out+=$string(RightAnswer||"  ");
	$out+='</pre> </div> <span class="color-green ">试题分析：</span> <div class="answer-ques"> <div id="explain-que" style="overflow:hidden;zoom:1;color:black">';
