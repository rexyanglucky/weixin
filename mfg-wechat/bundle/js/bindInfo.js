	        ...
	        success: function(data){
	            if(data)
	            {
	                if(data.OK)
	                {
	                    ...
	                    pop.showConfirm(' 确认要绑定学生'+stuname+'（'+stuid+'）么？',function(e){
	                        if(e)
	                        {
	                            bindStu();
	                        }
