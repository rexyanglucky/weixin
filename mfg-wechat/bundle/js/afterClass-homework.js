	    ...
	    $.ajax({
	        ...
	        success:function(data){
	            ...
	            if(data.OK){
	                ...
	                $("#nownum").html(index);
	                $("#sumnum").html(total);
	                var headline='<span class="text-name left" id="left">'+headlineTopic(data.N)+'</span>';
