	    ...
	    $.ajax({
	        ...
	        success:function(data){
	            ...
	            if(data.OK){
	                ...
	                var sumnum=data.N.QuestionCount;
	                data.N.index = index;
