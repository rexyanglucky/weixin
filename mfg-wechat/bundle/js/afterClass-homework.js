	    ...
	    $.ajax({
	        ...
	        success:function(data){
	            w.checkBind(data);
	                ...
	                var headline='  <div class="main-topic font-size16 border-bottom" class="headline" ><span class="text-name left" id="left">'+headlineTopic(data.N)+'</span><div class="topic-right-num right">(<span class="nownum"></span>/<span class="sumnum"></span>)</div></div>';
