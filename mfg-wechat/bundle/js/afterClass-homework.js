	    ...
	    $.ajax({
	        ...
	        success:function(data){
	            ...
	            if(data.OK){
	                ...
	                $("#nownum").html(index);
	                $("#sumnum").html(total);
	                var headline='<div class="main-topic font-size16 border-bottom" id="headline"><span class="text-name left" id="left">'+headlineTopic(data.N)+'</span></div>';
