	        ...
	        success:function(data){
	            ...
	            if(data.OK){
	               ...
	               /* $("#left").html(headlineTopic(data.N));*/
	                ...
	                $("#sumnum").html(total);
	                var headline=' <div class="main-topic font-size16 border-bottom" id="headline"> <span class="text-name left" id="left">'+headlineTopic(data.N)+'</span><div class="topic-right-num right">(<span id="nownum"></span>/<span id="sumnum"></span>)</div>';
