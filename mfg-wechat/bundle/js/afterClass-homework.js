...
/***/ function(module, exports, __webpack_require__) {
	...
	$out+=' <span class="text-name left" > 二、填空题</span> <div class="topic-right-num right" style="float:right">(<span class="nownum">';
	$out+=$escape(CurrentQuesIndexByType);
	$out+='</span>/<span class="sumnum">';
	$out+=$escape(CurrentQuesCountByType);
	$out+='</span>)</div> ';
	}else if( QuestionType==3){
	$out+=' <span class="text-name left" > 三、解答题</span> <div class="topic-right-num right" style="float:right">(<span class="nownum">';
	$out+=$escape(CurrentQuesIndexByType);
	$out+='</span>/<span class="sumnum">';
	$out+=$escape(CurrentQuesCountByType);
	$out+='</span>)</div> ';
