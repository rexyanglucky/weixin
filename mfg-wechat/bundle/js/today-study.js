	         ...
	         //开课提醒的数据
	          ...
	          var comparetime=function(gettime){
	            ...
	            $.each(datta,function(i,val) {
	                ...
	                str += '<div class="part speak" id="'+val.id+'"><img src="../bundle/img/detail_03.png"><span class="title">开讲啦</span><p>您好:<span class="first_span">' + val.userName + '</span>今天有课，快提醒他上课吧~</p><hr /><p  class="detailed"><span class="subject">' + courseName + '</span>（第<span  class="num">' + val.extendNum + '</span>次)<span class="datatime">' + start+ '</span>~<span class="datatime">' + end+ '</span></p></div>'
	             })
	            $('.main').append(str);
	            //快交作业了
	            $.each(datta1,function(i,val) {
	                ...
	                var courseName = home.getSubjectName(val.subject);
	                str1 += '<div class="part homework" id="'+val.id+'"><img src="../bundle/img/detail_06.png"><span class="title">快交作业啦</span><p>您好:<span class="first_span">' +val.userName + '</span>还有未交作业，快督促他交作业吧~</p><hr /><p  class="detailed"><span class="subject">' +courseName+'</span><span class="datatime">截止&nbsp;&nbsp;<span>'+comparetime(nowTimes)+'</span>&nbsp;' +start+ '</span></span></p></div>'
	             })
	            $('.main').append(str1);
	            //新学案
	            $.each(datta2,function(i,val){
	                ...
	                mytime(val,'MM月dd日');
	                var courseName = home.getSubjectName(val.subject);
	                str2 += '<div class="part module" id="'+val.id+'"><img src="../bundle/img/detail_09.png"><span class="title">收到一份新学案</span><p>您好:老师发布了新学案，快提醒<span class="first_span">' +val.userName + '</span>预习吧</p><hr /><p  class="detailed"><span class="subject">' +courseName+ '</span>（第<span  class="num">' +val.extendNum + '</span>次)<span class="datatime">上课&nbsp;&nbsp&nbsp;<span class="time">' +start+ '</span></span></p></div>'
	            })
	            //新作业
	            $('.main').append(str2);
	            $.each(datta3,function(i,val){
	                ...
	                comparetime(nowTimes);
	                var courseName = home.getSubjectName(val.subject);
	                str3 += '<div class="part newwork" id="'+val.id+'"><img src="../bundle/img/detail.png"><span class="title">收到一份新作业</span><p>您好:老师布置了新作业，快督促<span class="first_span">' +val.userName + '</span>作答吧~</p><hr /><p  class="detailed"><span class="subject">' +courseName+ '</span><span class="datatime">截止&nbsp;&nbsp<span>'+comparetime(nowTimes)+'</span>&nbsp;<span class="time">' +start+ '</span></span></p></div>';
	            })
	            $('.main').append(str3);
	        },
	        error: function (xhr, type) {
