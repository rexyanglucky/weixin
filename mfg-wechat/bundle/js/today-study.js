	         ...
	         //开课提醒的数据
	          ...
	          var comparetime=function(gettime){
	            ...
	            $.each(datta3,function(i,val){
	                ...
	                var stageName = home.getStageStr(val.bgrade);
	                var courseName = home.getSubjectName(val.subject);
	                str3 += '<div class="part newwork" id="'+val.id+'"><img src="../bundle/img/detail.png"><span class="title">收到一份新作业</span><p>您好:老师布置了新作业，快督促<span class="first_span">' +val.userName + '</span>作答吧~</p><hr /><p  class="detailed"><span class="subject">' + stageName + '' + courseName + '</span><span class="datatime">截止&nbsp;&nbsp;&nbsp;<span>' +mouth+ '月' +day+ '日&nbsp;' +date+ '</span></span></p></div>';
	            })
	            $('.main').append(str3);
	        },
	        error: function (xhr, type) {
