...
/***/ function(module, exports, __webpack_require__) {
	...
	$(function () {
	    //引入时间设置的插件
	    var WebStorageCache = __webpack_require__(59);
	    ...
	    $.ajax({
	        ...
	        //timeout: 300,
	        success: function (data) {
	          /* if(!data.N.HaveClassAlertList.length){
