	         ...
	         //开课提醒的数据
	          ...
	          var comparetime=function(gettime){
	            ...
	            $.each(datta,function(i,val) {
	                ...
	                str += '<div class="part speak" id="'+val.id+'"><img src="../bundle/img/detail_03.png"><span class="title">开讲啦</span><p>您好:<span class="first_span">' + val.userName + '</span>今天有课，快提醒他上课吧~</p><hr /><p  class="detailed"><span class="subject">' + stageName + '' + courseName + '</span><span  class="num">（第'+ val.extendNum + '次)</span><span class="datatime">' + start+ '~' + end+ '</span></p></div>'
	             })
	            $('.main').append(str);
	            //快交作业了
	            ...
	            $.each(datta3,function(i,val){
	                ...
	                //comparetime(nowTimes);
	                var courseName = home.getSubjectName(val.subject);
	                str3 += '<div class="part newwork" id="'+val.id+'"><img src="../bundle/img/detail.png"><span class="title">收到一份新作业</span><p>您好:老师布置了新作业，快督促<span class="first_span">' +val.userName + '</span>作答吧~</p><hr /><p  class="detailed"><span class="subject">' +courseName+ '</span><span class="datatime">截止&nbsp;&nbsp;&nbsp;<span class="time">' +start+ '</span></span></p></div>';
	            })
	            $('.main').append(str3);
	        },
	        error: function (xhr, type) {
