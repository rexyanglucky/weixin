	                ...
	                if (data) {
	                    if (data.OK) {
	                        ...
	                        sessionStorage.setItem('isbind',1);
	                            ...
	                            {
	                                window.location.href='../html/lookInfo.html';
	                                return;
	                            }
	                        }
	                    else {
