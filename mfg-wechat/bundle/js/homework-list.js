	        ...
	        if (isCourseReady && isTypeReady) {
	            ...
	            $.ajax({
	                ...
	                success: function(data) {
	                    ...
	                    if (num==1&&(!isListNull || isListNull.length == 0)) {
