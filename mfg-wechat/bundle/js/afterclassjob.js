	            ...
	            if(data.Result){
	                ...
	                $.each(data.N.PlanPointsList,function(index,item){
	                    if(item.CurrentLever == 2){
	                        $('.konwpoint').append(
	                            '<div id='+item.PlanPointsID+'><p class="point-title">知识点+'+index+'+:'+item.PointName+'</p></div>'
	                        );
	                    }else if(item.CurrentLever == 3){
	                        $('.testway').append('<div id='+item.PlanPointsID+'><p class="testway-title">考法+'+index+'+:'+item.PointName+'</p><div class="jingpin"><p>精品例题</p></div><div class="suitang"><p>随堂练习</p></div></div>');
	                    }
	                });
	            }
