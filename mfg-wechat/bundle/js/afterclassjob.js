	        ...
	        if(data.OK){
	            ...
	            if(data.OK){
	                for(var i=0;i<data.N.length;i++){
	                    ...
	                    message.data[i]={
	                        "id":data.N[i].planid,
	                        "name":data.N[i].orderNum > 0 ? data.N[i].GradeName + data.N[i].SubjectName+data[i].orderNum:data.N[i].GradeName + data.N[i].SubjectName,
	                    }
	                }
	            }
	            ...
	            if(data.Result){
	                ...
	                $.each(data.N.PlanPointsList,function(index,item){
	                    if(item.CurrentLever == 2){
	                        ...
	                        $('.testway').append('<div id='+item.PlanPointsID+'><p class="testway-title">考法'+wayIndex+':'+item.PointName+'</p><div class="jingpin"><p>精品例题</p></div><div class="suitang"><p>随堂练习</p></div></div>');
	                        wayIndex++;
	                    }
	                });
	            }
